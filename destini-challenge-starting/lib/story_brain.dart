...
// Hint: You might need to change something in story.dart to make this work.
  ...
  List<Story> _storyData = [
    Story(
        ...
        choice1: 'I\'ll hop in. Tha nks for the help!',
...
// Step 12 - Create a method called getChoice2() that returns the text for the first choice2 from _storyData.
  String getChoice2() {
    // return _storyData[0].choice_2;
    return _storyData[_storyNumber].choice_2;
  }

// Step 25 - Change the storyNumber property into a private property so that only story_brain.dart has access to it.
// You can do this by right clicking on the name (storyNumber) and selecting Refactor -> Rename to make the change across all the places where it's used.
...
// Step 20 - Download the story plan here:
// https://drive.google.com/uc?export=download&id=1KU6EghkO9Hf2hRM0756xFHgNaZyGCou3

    if (choiceNUmber == 1 && choiceNUmber == 0) {
      _storyNumber = 2;
    } else if (choiceNUmber == 2 && choiceNUmber == 0) {
      _storyNumber = 1;
    } else if (choiceNUmber == 1 && choiceNUmber == 1) {
      _storyNumber = 2;
    } else if (choiceNUmber == 2 && choiceNUmber == 1) {
      _storyNumber = 3;
    } else if (choiceNUmber == 1 && choiceNUmber == 2) {
      _storyNumber = 5;
    } else if (choiceNUmber == 2 && choiceNUmber == 2) {
      _storyNumber = 4;
    }

// Step 21 - Using the story plan, update nextStory() to change the storyNumber
...
// if storyNumber is 0 or 1 or 2 (when both buttons should show choices) and
